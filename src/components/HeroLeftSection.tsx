...
export default function HeroLeftSection() {
    return (
         <>
         <div className='xl:py-10 py-5 w-fit'>
        <div className="relative z-[50] flex flex-col xl:gap-y-6 gap-y-0 lg:py-0 justify-center items-center" >

            <div className='w-full h-auto'>
                <div className="flex items-center">
                    <h1 className={`w-fit h-auto font-bold leading-[0.9] ${teko.className} text-[clamp(5.5rem,10vw,8rem)]`}>
                ...
                <div className='flex items-center'>
                    ...
                    <div className='xl:block lg:hidden md:block hidden'>
                        <TextWrapper />
                    </div>
                </div>
            </div>
