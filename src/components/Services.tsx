...
const Services = () => {
  const services = [
    {
      ...
      description: "Create stunning, responsive websites that captivate your audience and drive results with cutting-edge technology.",
    ...
    },
    {
      ...
      description: "Amplify your brand's reach with data-driven marketing strategies that convert visitors into loyal customers.",
    ...
    },
    {
      ...
      title: "UI/UX Design",
      description: "Design intuitive, user-centered interfaces that provide exceptional experiences and maximize user engagement.",
    ...
    },
    {
      ...
      description: "Craft compelling content that tells your story, engages your audience, and drives meaningful connections.",
    ...
    },
    {
      ...
      description: "Build powerful online stores that drive sales with seamless shopping experiences and secure payment systems.",
    ...
    },
    {
      ...
      description: "Get expert guidance and strategic insights to accelerate your business growth and digital transformation.",
    ...
    },
    {
      ...
      description: "Create powerful mobile and web applications that deliver exceptional user experiences across all platforms.",
  ...
  return (
    <div className={` w-full h-auto py-16 px-4 ${outfit.className}`}>
      <div className='w-[90%] h-auto mx-auto'>
        <div className="text-center mb-16">
          <h1 className="text-6xl font-bold text-lime-400 mb-4">Our Services</h1>
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-lime-400 to-neutral-400 mx-auto mt-8 rounded-full"></div>
        </div>
          ...
          <div className="flex overflow-x-auto space-x-10">
            {services.map((service, index) => (
              <div
                ...
                style={{ animationDelay: `${index * 100}ms`, width: '350px' }} 
              >
